...
# The new, simple chamfer-based function
...
# Match from "def get_tab_points" to "return coords" (the buffer version)
pattern = r'(        def get_tab_points\(start_x, width, height, radius, direction=1\):.*?return coords)'
...
print("Replaced with chamfer-based rounding")
