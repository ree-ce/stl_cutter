...
# Simply SWAP the if/else branches for rotation direction
new_function = '''        def get_tab_points(start_x, width, height, radius, direction=1):
            """Generate tab points with arc bulging OUTWARD"""
            neck_w = width * 0.6
            head_w = width * 0.9 
...
print("Swapped rotation direction condition")
